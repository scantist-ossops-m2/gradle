...
public class ResolutionParameters {
    ...
    private final ImmutableList<? extends DependencyMetadata> syntheticDependencies;
    ...
    public ResolutionParameters(
        ...
        ImmutableList<? extends DependencyMetadata> syntheticDependencies,
    ...
    /**
     * Get the synthetic dependencies of this resolution -- those generated by Gradle and not
     * declared directly by the user. These are used for dependency locking and consistent resolution.
     * <p>
     * TODO: These should be part of the root variant.
     */
    public ImmutableList<? extends DependencyMetadata> getSyntheticDependencies() {
        return syntheticDependencies;
    }
     ...
     * <p>
     * TODO: This should go away. Observing the actual artifacts of an artifact set during
